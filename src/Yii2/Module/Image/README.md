...
Т.к эта возможность становится доступной после установки модуля достаточно сделать вызов функции.
Функция принимает 2 обязательных параметра и один необязательный.
1. Прараметр путь к изображению смотрите выше.
2. Параметр формат изображения.
3. Параметр это родной параметр options, о нем вы можете узнать из офицальной документации.
